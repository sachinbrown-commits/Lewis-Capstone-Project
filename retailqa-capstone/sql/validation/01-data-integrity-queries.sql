...
SELECT
    o.Id AS OrderId,
    o.Total AS StoredOrderTotal,
    SUM(oi.LineTotal) AS CalculatedOrderTotal,
    CASE
        WHEN o.Total = SUM(oi.LineTotal) THEN 'PASS'
        ELSE 'FAIL'
    END AS Result
FROM Orders o
JOIN OrderItems oi ON oi.OrderId = o.Id
WHERE o.Id = 'LWS-76042'
GROUP BY o.Id, o.Total;
...
WHERE u.Email = 'test.customer@lewisstores.local';
